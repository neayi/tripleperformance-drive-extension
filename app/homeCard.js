...
function card_onHomepage(event) {
    ...
    try {
        ...
        .addSubMenu(ui.createMenu('Traitements en lots')
            ...
            .addSeparator()
            .addItem("Découvrir les liens interlangues", 'analyzeTranslations')
            .addItem("Corriger les liens interlangues", 'fixTranslations')
        )
...
function loadAllContributors() {
    Logger.log("loadAllContributors")
    let speakers = new speakersModel();
    speakers.buildContributorsSheet();
}
